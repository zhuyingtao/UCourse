...
public class ExamAdder extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.exam_adder);
        ...
        showAlert = (TextView) this.findViewById(R.id.exam_adder_showalert);
        showAlert.setText("不使用提醒");// 初始化提醒

        btn_tiqian = (Button) this.findViewById(R.id.exam_adder_alert);
    ...
    public void setButtonOK() {
        Button button = (Button) findViewById(R.id.exam_adder_ok);
        button.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                EditText et1 = (EditText) findViewById(R.id.exam_adder_course);
                EditText et2 = (EditText) findViewById(R.id.exam_adder_place);
                ...
                if (examName == null || examName.length() == 0) {
                    Toast.makeText(ExamAdder.this, "请填写完整信息!",
    ...
    private void showAlarmDialog() {
        AlertDialog ad = new AlertDialog.Builder(ExamAdder.this)
                .setTitle("选择提醒时间")
