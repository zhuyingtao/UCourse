...
public class CourseAdd extends Activity {
	// 控件区
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCiCursor = mCourseInfoDB.select();
	...
	private void viewInit() {
		...
		buttonset.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				intent.setClass(CourseAdd.this, CourseTime.class);
		...
		buttonyes.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (func.isEmpty(course_name) || func.isEmpty(course_teacher)
					...
					mCourseDB.insert(course_name, course_room, course_teacher,
							course_week_start, course_week_end);
					mCoCursor.requery();
					mCourseInfoDB.insert(course_name, course_time_hour,
							course_time_min, course_day, course_class_start,
							course_class_end);
					mCiCursor.requery();
					myactivity
